			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<div class="top_nav_left">
					<nav class="cl-effect-15" id="cl-effect-15">
						<ul>
							<li><a href="yourbookings.php "><img  src="images/icon-back-arrow.png"></img></a></li>
...
<div class="container">	
	...
	<!--Payment-->
							...
							<div class="tab2">
								<div class="pay_info">
									<form  method="POST" action="pgResponse1.php" class="creditly-card-form agileinfo_form">
										...
										<div class="credit-card-wrapper">
												<div class="first-row form-group">
													...
													<div class="controls">
														...
														<input class="expiration-month-and-year form-control" type="text" name="exp_date" id="exp_date"   pattern="([0-9]{2}[/]?){2}" placeholder="MM / YY" required>
													</div>
												</div>
