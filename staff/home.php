...
<html lang="en" class="h-100">
  ...
  <meta charset="utf-8">
    ...
    <title>PARK-iN | STAFF | Change Password</title>
...
<br><br><br>
    ...
    <h1 class="txt-title float-md-start mb-0">#Staff </h1>
...
if($count>0)
{
 $conn=mysqli_query($conn,"update user set password='".$_POST['newpassword']."' where type='staff' and email='".$_SESSION['login']."'");
...
{?>
  <meta http-equiv = "refresh" content = "2; url = http://localhost/carparking/staff/home.php" />
