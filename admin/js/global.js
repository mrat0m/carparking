$(document).ready(function(){
    ...
    */
    $(".passport_photo").change(function(){
    	if($(this).val() != ""){
    		...
    		$(".passportPhoto_file").html("Upload staff Photo");
    	}
    })
	...
	$(".passport-btn").click(function(e){ //on add input button click
	    ...
	    myFormData.append('staff_photo', $(".passport_photo").prop('files')[0]);
    ...
    */
    $(".nationalID").change(function(){
    	if($(this).val() != ""){
    		...
    		$(".nationalID_file").html("Upload staff Photo");
    	}
    })
	...
	$(".nationID-btn").click(function(e){ //on add input button click
	    ...
	    var myFormData = new FormData();
	    myFormData.append('staff_ID', $(".nationalID").prop('files')[0]);
    ...
    */
    $("#addstaff").submit(function(e){
    	...
    	if($(".datejoined").val() == ""){
    		datejoinederror = "Please enter staffloyment date";
    	} else {
    		datejoinederror = "";
    	}

    	if($(".staffstatus").val() == ""){
    		staffstatuserror = "Please select status of staff";
    	} else {
    		staffstatuserror = "";
    	}
    	...
    	if($(".resdirection").val() == ""){
    		resdirectionerror = "Please enter direction to staff's residence";
    	} else {
    		resdirectionerror = "";
    	}
    	...
    	$(".datejoinederror").html(datejoinederror);
    	$(".staffstatuserror").html(staffstatuserror);
    	...
    	if(firstnameerror == "" && middlenameerror == "" && lastnameerror == "" && phoneerror == "" && jobtypeerror == "" && datejoinederror == "" && resaddresserror == "" && reslocationerror == "" && gpsreslocationerror == "" && resdirectionerror == "" && photoerror == "" && IDnumbererror == "" && fullnameerror == "" && idtypeerror == "" && nationalIDerror == "" && relationshiperror == "" && kinphoneerror == "" && kinresaddresserror == "" && kinresdirectionerror == "" && staffstatuserror == "") {

    		$(".displaySuccess").css({
    			"margin-top":"0px",
    			"opacity":"1"
    		})
			$(".displaySuccess").html('<span class="spinicon"><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i></span> Adding new staff record');
    		...
    		$.ajax({
		    	...
		    	success: function(data){
					...
					if(status == "Success"){
						...
						$(".displaySuccess").css("background","#ff0000");
						$(".displaySuccess").html('<span class="spinicon"><i class="fa fa-exclamation-circle fa-1x"></i></span> staff ID already exists')
						setTimeout(function(){
							$(".displaySuccess").css({
				    			"margin-top":"",
				    			"opacity":"",
    ...
    */
    $("#editstaff").submit(function(e){
    	...
    	if(firstnameerror == "" && middlenameerror == "" && lastnameerror == "" && phoneerror == "" && jobtypeerror == "" && datejoinederror == "" && resaddresserror == "" && reslocationerror == "" && gpsreslocationerror == "" && resdirectionerror == "" && IDnumbererror == "" && fullnameerror == "" && idtypeerror == "" &&  relationshiperror == "" && kinphoneerror == "" && kinresaddresserror == "" && kinresdirectionerror == "" && staffstatuserror == "") {
...
function searchFilter(page_num) {
	...
	$.ajax({
	    ...
	    beforeSend: function () {
	        ...
	        $("#displaystaffList").css("opacity","0.3");
	    },
	    success: function (data) {
	        $('#displaystaffList').html(data);
	        $("#displaystaffList").css("opacity","1");
	    }
	})
}
...
/*
	Get staff data
*/
$("#displaystaffList").on('click', '.action_view', function(){
...
*/
$("#displaystaffList").on('click', '.action_delete', function(){
	var id = $(this).attr("data-id");
...
$("#displaystaffList").on('click', '.action_edit', function(){
	var id = $(this).attr("data-id");
