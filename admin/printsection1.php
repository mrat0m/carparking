...
<html lang="en" class="h-100">
  <head>
    ...
    <meta http-equiv="refresh" content="0; url=http://localhost/carparking/admin/booking_report.php" />
...
<body style="font-family: 'Times New Roman', Times, serif;" onload="printDiv()">
...
<p align="left" style="margin-top: -50px;"> <i class="fa fa-address-card" aria-hidden="true"></i> PARK-iN, Park-in Street,India. 
                     <br><i class="fa fa-phone" aria-hidden="true"></i> +1 234 567 
                  <br><i class="fa fa-envelope" aria-hidden="true"></i> park.in@gmail.com</p>
...
<table align="center" class="table" style="width: auto;"></h4><br>
  <thead>
...
<br><br>
<table align="center" style="color: blue; font-size: 40px;"> 
<tr>
    <th >Total Amount : </th>
    <?php 
       
        if(sizeof($_SESSION['valtot'])>0){ ?>
        <td><?php echo $_SESSION['valtot'][0]['tot']; ?></td>
